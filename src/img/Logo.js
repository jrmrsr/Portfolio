...
const SVG = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} className={className} viewBox={viewBox}>
        <path fill="rgb(255,52,25)" stroke="none" d="M0 75C0 33.5786 33.5786 0 75 0C116.421 0 150 33.5786 150 75C150 116.421 116.421 150 75 150C33.5786 150 0 116.421 0 75Z"/>
        <defs>
            <clipPath id="clip_0">
