...
export default class About extends Component {
  render() {
    ...
    const aboutMe = <span><p  className="animated fadeInLeft" style={{marginTop:0}}>> I believe that our ability to 
    ...
    Someday, I hope to help people with my own design practice.<br/></p><span className="animated fadeInLeft">{button}</span></span>
    
    const header = <h1 className="main-header-text animated fadeInLeft" onClick={() => this.props.handleClickAboutInfo()}>My name is Jose Rondon and I am an aspiring engineer.{button}</h1>;
