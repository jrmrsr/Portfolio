...
export default class AboutMe extends Component {
  render() {
    ...
    creative and skillful design. So far, I've been able to explore building design at a <a className="link" href="http://smithandandersen.com/" target="_blank" rel="noopener noreferrer">consulting firm</a> firm,
    quality engineering at a <a className="link" href="https://www.futureadvisor.com/" target="_blank" rel="noopener noreferrer">financial technology startup</a>,
    and the complexities of network infrastructure at a <a className="link" href="https://www.shaw.ca/store/" target="_blank" rel="noopener noreferrer">telecoms company</a>.
